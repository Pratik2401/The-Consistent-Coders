export const upcomingSessions = [
    {
        ...
        example: 'Seats: 50 remaining. Level: Intermediate. Instructor: Arjun Mehta (3 yrs React, ex-Razorpay). Register via Discord or the link below.',
    },
    {
        ...
        example: 'Seats: 30 remaining. Level: All levels. Panelists: Priya Sharma (Hiring Lead, TechMint) + 2 TCC senior members. Submit your portfolio for live roast by April 20.',
    },
    {
        id: 'session-system',
        tag: 'ADVANCED',
        ...
        example: 'Seats: 25 remaining. Level: Intermediate/Advanced. Instructor: Rohit Kumar (System Design, ex-Flipkart). Great prep for senior/FAANG interviews.',
    },
    {
        id: 'session-doubt',
        tag: 'DOUBT SOLVING',
        ...
        example: 'Recurring session. Free for all members. Drop into the Discord server and hit the #sunday-doubt-session channel to queue up. No registration needed.',
    },
];
